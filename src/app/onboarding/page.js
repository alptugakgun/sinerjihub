...
export default function OnboardingPage() {
  ...
  // Platformun ruhunu yansıtan roller
  const roles = [
  ...
  // Farklı disiplinleri harmanlayan ilgi alanları
  const interests = [
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-gray-800/80 backdrop-blur-lg border border-gray-700 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
        ...
        {step === 1 && (
          <div className="space-y-8 animate-fade-in-up">
            <div className="text-center">
              ...
              <p className="text-gray-400">Önce seni biraz tanıyalım. SinerjiHub'da kendini nasıl tanımlarsın? (Birden fazla seçebilirsin)</p>
            </div>
        ...
        {/* Adım 2: İlgi Alanları ve Yetenekler */}
        {step === 2 && (
          <div className="space-y-8 animate-fade-in-up">
            <div className="text-center">
        ...
        {step === 3 && (
          <div className="space-y-8 text-center animate-fade-in-up">
            ...
            <p className="text-gray-400 max-w-md mx-auto">
              Seçimlerine göre sana en uygun çalışma odalarını, kabileleri ve ilanları bulmak için algoritmamızı çalıştırıyoruz.
            </p>
          </div>
        )}
        ...
        <div className="mt-12 flex justify-between items-center">
          ...
          {step < 3 ? (
            ...
            <Link 
              href="/dashboard"
              className="px-8 py-3 rounded-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white shadow-[0_0_20px_rgba(147,51,234,0.4)] transition-all mx-auto"
            >
              Kabileme Git 🚀
            </Link>
          )}
